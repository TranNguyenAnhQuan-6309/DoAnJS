...
export class AdminFormComponent {
  ...
  onAddCategory(form: { valid: any; controls: { category_add: { value: any; }; }; reset: () => void; }) {
    if (form.valid) {
      this.isLoading = true;
  ...
  validateForm(form: { controls: { prod_name: { value: any; pristine: any; }; price: { value: any; pristine: any; }; category: { value: any; pristine: any; }; }; pristine: any; }) {
